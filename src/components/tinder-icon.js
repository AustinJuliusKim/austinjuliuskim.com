...
const TinderIcon = props => (
  ...
  >
    ...
    <linearGradient
      ...
      y2="9.8297"
    >
      <stop offset="0" style={{ stopColor: "#FF0674" }} />
      <stop offset="1" style={{ stopColor: "#FF813F" }} />
    </linearGradient>
    <circle className="st0" cx="32" cy="32" r="31" fill="url(#SVGID_1_)" />
    <path
      className="st1"
      fill="#FFF"
      d="M33,14.7c0,0.1,0,0.3,0,0.5c0.2,0.8,0.2,3.5,0.1,4.4c-0.1,0.6-0.1,0.9-0.2,1.1c0,0.1-0.1,0.2-0.1,0.3
